...
\begin{itemize}
    ...
    \item go to room $5$: travel $6$, open for $1$, finish at time $12$
    \item go to room $6$: travel $10$, open for $2$, finish at time $24$
\end{itemize}
All deadlines are met, so the answer is $24$.
