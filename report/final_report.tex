...
\begin{description}
  ...
  \item[\texttt{secret10\_k18\_star\_dense\_states}]
        ...
        deadlines are very tight.  Exercises the maximum number of DP states
        ($2^{18}\times18$) and large edge weights (up to $10^{15}$).
        Tests overflow and DP completeness.
  ...
  \item[\texttt{secret13\_large\_binary\_stress}]
        $N\approx130\,000$, $K=18$, balanced binary tree.  Structured but
